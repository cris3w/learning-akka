package examples.udemy.s8_AkkaHttp.RestApi
...
import examples.udemy.s8_AkkaHttp.RestApi.db.TweetManager
import examples.udemy.s8_AkkaHttp.RestApi.model.{Tweet, TweetEntity}
...
trait RestApi {
  import examples.udemy.s8_AkkaHttp.RestApi.model.TweetProtocol._
  import examples.udemy.s8_AkkaHttp.RestApi.model.TweetEntity._
  import examples.udemy.s8_AkkaHttp.RestApi.model.TweetEntityProtocol.EntityFormat
